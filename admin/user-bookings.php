            ...
            <div class="main">
              ...
              <i class="hamburger align-self-center"></i>
                ...
                <main class="content">
                    ...
                    <h1 class="h3 mb-3">Manage
                        <?php echo $_GET['uname'];?>'s Bookings</h1>
    ...
    <div class="row">
        ...
        {				?>
                                        <tr>
                                            ...
                                            <td><a href="update-package.php?pid=<?php echo htmlentities($result->pid);?>">
                                                    <?php echo htmlentities($result->pckname);?>
                                                </a></td>
                                            <td>
                                                <?php echo htmlentities($result->fdate);?> To
