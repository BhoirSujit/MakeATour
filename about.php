...
<script>
  let activenav = document.querySelector("#navabout");
  ...
  <main id="main">
    ...
    <div class="breadcrumbs" data-aos="fade-in">
      <div class="container">
        <h2>About Us</h2>
        <p>Welcome to MakeATour, your ultimate destination for effortless travel planning and unforgettable experiences. At MakeATour, we understand that every journey is unique, and that's why we're dedicated to empowering travelers like you to create personalized adventures tailored to your interests and preferences. </p>
      </div>
    </div><!-- End Breadcrumbs -->
